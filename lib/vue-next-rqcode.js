import { defineComponent as Se, ref as Fe, onMounted as Qe, createVNode as nt, Fragment as Ne } from "vue";
import { NSpin as Oe, NButton as Ue } from "naive-ui";
const Ge = {
  status: {
    type: String,
    default: "success"
...
var Ot = {}, Rt = {};
const ze = "bold|bolder|lighter|[1-9]00", He = "italic|oblique", je = "small-caps", $e = "ultra-condensed|extra-condensed|condensed|semi-condensed|semi-expanded|expanded|extra-expanded|ultra-expanded", Ke = "px|pt|pc|in|cm|mm|%|em|ex|ch|rem|q", pe = `'([^']+)'|"([^"]+)"|[\\w\\s-]+`, Xe = new RegExp(`(${ze}) +`, "i"), Je = new RegExp(`(${He}) +`, "i"), We = new RegExp(`(${je}) +`, "i"), Ze = new RegExp(`(${$e}) +`, "i"), Ve = new RegExp(
  `([\\d\\.]+)(${Ke}) *((?:${pe})( *, *(?:${pe}))*)`
), Yt = {}, qe = 16;
var Ye = (e) => {
  if (Yt[e])
  ...
  switch ((l = Xe.exec(y)) && (t.weight = l[1]), (u = Je.exec(y)) && (t.style = u[1]), (f = We.exec(y)) && (t.variant = f[1]), (h = Ze.exec(y)) && (t.stretch = h[1]), t.unit) {
    case "pt":
      t.size /= 0.75;
      break;
    case "pc":
...
var fr = function(a, t, l) {
  ...
  return function(t) {
    ...
    return Object.keys(a).reduce(function(h, y) {
      var m = a[y];
      return m.length ? h[y] = fr(u, m.index, m.length) : h[y] = u[m.index], h;
    }, {});
  };
};
S.readBits = cr;
...
var hr = 100, F = 256, me = F - 1, at = 4, De = 16, re = 1 << De, ke = 10, ie = 10, dr = re >> ie, vr = re << ke - ie, gr = F >> 3, te = 6, pr = 1 << te, mr = gr * pr, yr = 30, Te = 10, Mt = 1 << Te, Me = 8, ye = 1 << Me, wr = Te + Me, ct = 1 << wr, we = 499, be = 491, _e = 487, Le = 503, br = 3 * Le;
function _r(e, a) {
  var t, l, u, f, h;
  function y() {
  ...
  function w(i, n, v, d, p) {
    t[n][0] -= i * (t[n][0] - v) / Mt, t[n][1] -= i * (t[n][1] - d) / Mt, t[n][2] -= i * (t[n][2] - p) / Mt;
  }
  ...
  function r() {
    var i, n = e.length, v = 30 + (a - 1) / 3, d = n / (3 * a), p = ~~(d / hr), _ = Mt, R = mr, C = R >> te;
    for (C <= 1 && (C = 0), i = 0; i < C; i++)
      h[i] = _ * ((C * C - i * i) * ye / (C * C));
    var x;
    n < br ? (a = 1, x = 3) : n % we !== 0 ? x = 3 * we : n % be !== 0 ? x = 3 * be : n % _e !== 0 ? x = 3 * _e : x = 3 * Le;
    var k, g, T, A, D = 0;
    for (i = 0; i < d; )
      if (k = (e[D] & 255) << at, g = (e[D + 1] & 255) << at, T = (e[D + 2] & 255) << at, A = B(k, g, T), w(_, A, k, g, T), C !== 0 && E(C, A, k, g, T), D += x, D >= n && (D -= n), i++, p === 0 && (p = 1), i % p === 0)
        for (_ -= _ / v, R -= R / yr, C = R >> te, C <= 1 && (C = 0), A = 0; A < C; A++)
...
var Br = _r, Be = -1, Lt = 12, Bt = 5003, Cr = [
  0,
  1,
  3,
  7,
...
function Rr(e, a, t, l) {
  ...
  function T(A, D) {
    for (m &= Cr[w], w > 0 ? m |= A << w : m = A, w += v; w >= 8; )
      d(m & 255, D), m >>= 8, w -= 8;
    if ((B > b || s) && (s ? (b = k(v = r), s = !1) : (++v, v == Lt ? b = 1 << Lt : b = k(v))), A == c) {
      for (; w > 0; )
        d(m & 255, D), m >>= 8, w -= 8;
      x(D);
    }
...
for (var It = 0; It < 256; It++)
  G.charMap[It] = String.fromCharCode(It);
...
L.prototype.analyzePixels = function() {
  this.colorTab || (this.neuQuant = new Ar(this.pixels, this.sample), this.neuQuant.buildColormap(), this.colorTab = this.neuQuant.getColormap()), this.dither ? this.ditherPixels(this.dither.replace("-serpentine", ""), this.dither.match(/-serpentine/) !== null) : this.indexPixels(), this.pixels = null, this.colorDepth = 8, this.palSize = 7, this.transparent !== null && (this.transIndex = this.findClosest(this.transparent, !0));
};
...
L.prototype.writePixels = function() {
  var e = new Er(this.width, this.height, this.indexedPixels, this.colorDepth);
  e.encode(this.out);
};
L.prototype.stream = function() {
  return this.out;
};
var xr = L, Nt = U && U.__assign || function() {
...
}, Dr = U && U.__awaiter || function(e, a, t, l) {
  function u(f) {
...
}, kr = U && U.__generator || function(e, a) {
...
}, Tr = U && U.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(Ot, "__esModule", { value: !0 });
Ot.AwesomeQR = void 0;
var J = Rt, Ce = Ae, St = ee, Mr = Tr(xr), Ft = 0.4, Lr = (
  /** @class */
  function() {
    function e(a) {
      ...
      this.options = t, this.canvas = J.createCanvas(a.size, a.size), this.canvasContext = this.canvas.getContext("2d"), this.qrCode = new St.QRCodeModel(-1, this.options.correctLevel), Number.isInteger(this.options.maskPattern) && (this.qrCode.maskPattern = this.options.maskPattern), Number.isInteger(this.options.version) && (this.qrCode.typeNumber = this.options.version), this.qrCode.addData(this.options.text), this.qrCode.make();
    }
    return e.prototype.draw = function() {
      ...
      return Dr(this, void 0, void 0, function() {
        var d, p, _, R, C, x, k, g, T, A, D, P, tt, I, $, Z, et, K, ht, dt, vt, M, W, gt, Pt, Q, st, Ht, N, O, jt, lt, ne, X, M, $t, Kt, ae, z, oe, M, V, H, j, At, Xt, M, Jt, se, Wt, le, M, V, H, j, ue, pt, rt, mt, it, yt, Et, fe, q, ut, wt, ft, Zt, xt, ce, he, Vt, de;
        return kr(this, function(bt) {
          switch (bt.label) {
            case 0:
            ...
            case 2:
              return gt = bt.sent(), this.options.autoColor && (Pt = e._getAverageRGB(gt), this.options.colorDark = "rgb(" + Pt.r + "," + Pt.g + "," + Pt.b + ")"), I.drawImage(gt, 0, 0, gt.width, gt.height, 0, 0, A, A), I.rect(0, 0, A, A), I.fillStyle = k, I.fill(), [3, 4];
            case 3:
              I.rect(0, 0, A, A), I.fillStyle = this.options.colorLight, I.fill(), bt.label = 4;
            case 4:
              for (Q = St.QRUtil.getPatternPosition(this.qrCode.typeNumber), st = ((l = (t = this.options.components) === null || t === void 0 ? void 0 : t.data) === null || l === void 0 ? void 0 : l.scale) || Ft, Ht = (1 - st) * 0.5, N = 0; N < d; N++)
                for (O = 0; O < d; O++) {
              ...
              for (P.fillStyle = this.options.colorDark, P.fillRect(0, 0, 7 * g, g), P.fillRect((d - 7) * g, 0, 7 * g, g), P.fillRect(0, 6 * g, 7 * g, g), P.fillRect((d - 7) * g, 6 * g, 7 * g, g), P.fillRect(0, (d - 7) * g, 7 * g, g), P.fillRect(0, (d - 7 + 6) * g, 7 * g, g), P.fillRect(0, 0, g, 7 * g), P.fillRect(6 * g, 0, g, 7 * g), P.fillRect((d - 7) * g, 0, g, 7 * g), P.fillRect((d - 7 + 6) * g, 0, g, 7 * g), P.fillRect(0, (d - 7) * g, g, 7 * g), P.fillRect(6 * g, (d - 7) * g, g, 7 * g), P.fillRect(2 * g, 2 * g, 3 * g, 3 * g), P.fillRect((d - 7 + 2) * g, 2 * g, 3 * g, 3 * g), P.fillRect(2 * g, (d - 7 + 2) * g, 3 * g, 3 * g), At = ((B = (E = this.options.components) === null || E === void 0 ? void 0 : E.timing) === null || B === void 0 ? void 0 : B.scale) || Ft, Xt = (1 - At) * 0.5, M = 0; M < d - 8; M += 2)
                e._drawDot(P, 8 + M, 6, g, Xt, At), e._drawDot(P, 6, 8 + M, g, Xt, At);
              for (Jt = ((s = (b = this.options.components) === null || b === void 0 ? void 0 : b.cornerAlignment) === null || s === void 0 ? void 0 : s.scale) || Ft, se = (1 - Jt) * 0.5, e._drawAlign(P, z, z, g, se, Jt, this.options.colorDark, ((o = (r = this.options.components) === null || r === void 0 ? void 0 : r.cornerAlignment) === null || o === void 0 ? void 0 : o.protectors) || !1), Wt = ((i = (c = this.options.components) === null || c === void 0 ? void 0 : c.alignment) === null || i === void 0 ? void 0 : i.scale) || Ft, le = (1 - Wt) * 0.5, M = 0; M < Q.length; M++)
                for (V = 0; V < Q.length; V++)
                  if (H = Q[V], j = Q[M], !(H === 6 && (j === 6 || j === z))) {
                    if (j === 6 && (H === 6 || H === z))
                      continue;
            ...
            case 5:
              ue = bt.sent(), pt = this.options.logoScale, rt = this.options.logoMargin, mt = this.options.logoCornerRadius, (pt <= 0 || pt >= 1) && (pt = 0.2), rt < 0 && (rt = 0), mt < 0 && (mt = 0), it = T * pt, yt = 0.5 * (A - it), Et = yt, P.restore(), P.fillStyle = "#FFFFFF", P.save(), e._prepareRoundedCornerClip(P, yt - rt, Et - rt, it + 2 * rt, it + 2 * rt, mt + rt), P.clip(), fe = P.globalCompositeOperation, P.globalCompositeOperation = "destination-out", P.fill(), P.globalCompositeOperation = fe, P.restore(), P.save(), e._prepareRoundedCornerClip(P, yt, Et, it, it, mt), P.clip(), P.drawImage(ue, yt, Et, it, it), P.restore(), P.save(), P.translate(R, R), bt.label = 6;
            case 6:
              if ($) {
                if (Z.forEach(function(ot) {
                  q || (q = new Mr.default(p, p), q.setDelay(ot.delay), q.setRepeat(0));
                  var Dt = ot.dims, kt = Dt.width, Tt = Dt.height;
                  ut || (ut = J.createCanvas(kt, Tt), wt = ut.getContext("2d"), wt.rect(0, 0, ut.width, ut.height), wt.fillStyle = "#ffffff", wt.fill()), (!ft || !xt || kt !== ft.width || Tt !== ft.height) && (ft = J.createCanvas(kt, Tt), Zt = ft.getContext("2d"), xt = Zt.createImageData(kt, Tt)), xt.data.set(ot.patch), Zt.putImageData(xt, 0, 0), wt.drawImage(ft, ot.dims.left, ot.dims.top);
                  ...
                  var qt = J.createCanvas(p, p), ge = qt.getContext("2d");
                  ge.drawImage(ve, 0, 0, p, p), q.addFrame(ge.getImageData(0, 0, qt.width, qt.height).data);
                }), !q)
                  throw new Error("No frames.");
                return q.finish(), Re(this.canvas) ? (ce = q.stream().toFlattenUint8Array(), he = ce.reduce(function(ot, Dt) {
                  return ot + String.fromCharCode(Dt);
                }, ""), [2, Promise.resolve("data:image/gif;base64," + window.btoa(he))]) : [2, Promise.resolve(Buffer.from(q.stream().toFlattenUint8Array()))];
              } else
                return I.drawImage(D, 0, 0, A, A), P.drawImage(tt, -R, -R, A, A), Vt = J.createCanvas(p, p), de = Vt.getContext("2d"), de.drawImage(D, 0, 0, p, p), this.canvas = Vt, Re(this.canvas) ? [2, Promise.resolve(this.canvas.toDataURL())] : [2, Promise.resolve(this.canvas.toBuffer())];
          }
        });
      });
    }, e.CorrectLevel = St.QRErrorCorrectLevel, e.defaultComponentOptions = {
      data: {
        scale: 1
      },
      timing: {
      ...
      colorDark: "#000000",
      colorLight: "#ffffff",
      correctLevel: St.QRErrorCorrectLevel.M,
...
const Ct = /* @__PURE__ */ Se({
  ...
  render() {
    ...
    }, [this.$slots.errorAction ? this.$slots.errorAction() : nt(Ne, null, [nt(Ue, {
      text: !0,
      color: "#ffffff"
    }, {
...
typeof window < "u" && window.Vue && Ie(window.Vue);
const Qr = {
  install: Ie,
  QRCode: Ct
};
